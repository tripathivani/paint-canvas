...
const setCanvasBackground = () => {
    // setting the whole canvas background to white, so the download img background will be white 
    ctx.fillStyle = "#fff";
...
const drawRect = (e) => {
    //if fillcolor isn't checked draw a rect with bordder else drwa rect with background
...
const drawTriangle = (e) => {
    ...
    ctx.moveTo(prevMouseX, prevMouseY); // moving triangleto the mouse pointer
